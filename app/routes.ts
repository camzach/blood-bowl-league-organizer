...
export default [
  ...
  layout("./primary-layout.tsx", [
    ...
    layout("./routes/team/loader.tsx", [
      ...
      // Team edit action routes
      layout("./routes/team/team-permission-middleware.ts", [ // <- this middleware needs to be created
        route("/team/:teamId/edit", "./routes/team/edit/page.tsx"),
        route("/team/:teamId/edit/staff", "./routes/team/edit/staff.action.ts"),
        route("/team/:teamId/edit/hire-player", "./routes/team/edit/hire-player.action.ts"),
        route("/team/:teamId/edit/state", "./routes/team/edit/state.action.ts"),
        route("/team/:teamId/edit/player/:playerId/update", "./routes/team/edit/player/$playerId/update.action.ts"),
        route("/team/:teamId/edit/player/:playerId/fire", "./routes/team/edit/player/$playerId/fire.action.ts"),
        route("/team/:teamId/edit/player/:playerId/advance", "./routes/team/edit/player/$playerId/advance.action.ts"),
      ])
    ]),
